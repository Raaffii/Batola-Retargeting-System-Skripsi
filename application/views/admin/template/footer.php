    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [<?php echo $jumlahpelanggansenin ?>, <?php echo $jumlahpelangganselasa ?>, <?php echo $jumlahpelangganrabu ?>, <?php echo $jumlahpelanggankamis ?>, <?php echo $jumlahpelangganjumat ?>, <?php echo $jumlahpelanggansabtu ?>, <?php echo $jumlahpelangganminggu ?>],
                maxBarThickness: 6
            }, ],
        },
        options: {
